...
//
//
//  Created by Pavel Koyushev on 27.01.2024.
//
...
private struct PopOverController<Content: View>: UIViewControllerRepresentable {
...
private final class CustomHostingView<Content: View>: UIHostingController<Content> {
